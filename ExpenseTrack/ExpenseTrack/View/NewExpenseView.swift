...
//  ExpenseTrack
//
//  Created by Cevher Şirin on 6.02.2024.
//
...
struct NewExpenseView: View {
                ...
                HStack(spacing: 5) {
                    ZStack {
                        Image(systemName: "circle")
                            .font(.title3)
                            .foregroundStyle(checkBoxTint(category: category))
    ...
    func checkBoxTint(category: Category) -> Color {
